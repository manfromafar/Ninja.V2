...
void more_config( cJSON *root ) {
	...
	BONUS_ACCOUNT_ID = safe_strtoull( config_item(root, "bonusNumericAccountId") );
	BONUS_ACCOUNT_RS = Account::accountID_to_RS_string( BONUS_ACCOUNT_ID );
	BONUS_ACCOUNT_PASSPHRASE = config_item(root, "bonusEncodedPassphrase");
